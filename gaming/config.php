...
define("SITE_SALT", "pJd7x8bVKL141thQdsaUDP=fz2v@-hYp,RDYXo6ootE:H!BCmMPN;~BS=||Hy50r2On");
...
define("SITE_HANDLE", "article_gaming");
...
$config['site-name'] = "Gaming";
$config['database']['name'] = "article_gaming";
...
if(ENVIRONMENT == "production") {
	...
	// Set Important URLs
	define("SITE_URL", "http://gaming.unifaction.com");
	define("CDN", "http://cdn.unifaction.com");
	
	// Important Configurations
	$config['site-domain'] = "gaming.unifaction.com";		#production
...
************************************/
	...
	// Set Important URLs
	define("SITE_URL", "http://gaming.phptesla.com");
	define("CDN", "http://cdn.phptesla.com");
	
	// Important Configurations
	$config['site-domain'] = "gaming.phptesla.com";		#development
...
******************************/
	...
	// Set Important URLs
	define("SITE_URL", "http://gaming.test");
	define("CDN", "http://cdn.test");
	
	// Important Configurations
	$config['site-domain'] = "gaming.test";
