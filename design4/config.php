...
define("SITE_SALT", "IGPvAMFqSn=pXh157lXl0iXakYe8-qWna:#*h@s88.Nyro5vLpk4DFS@N5fLJmgv4eD");
...
if(ENVIRONMENT == "production") {
	...
	// Set Important URLs
	define("SITE_URL", "http://design4.today");
	define("CDN", "http://cdn.unifaction.com");
	
	// Important Configurations
	$config['site-domain'] = "design4.today";		#production
...
************************************/
	...
	// Set Important URLs
	define("SITE_URL", "http://design4.today.phptesla.com");
	define("CDN", "http://cdn.phptesla.com");
	
	// Important Configurations
	$config['site-domain'] = "design4.today.phptesla.com";		#development
...
******************************/
	...
	// Set Important URLs
	define("SITE_URL", "http://design4.today.test");
	define("CDN", "http://cdn.test");
	
	// Important Configurations
	$config['site-domain'] = "design4.today.test";
