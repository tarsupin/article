...
/****** Plugin Variables ******/
	public static int $duration = 1;		// <int> The duration of time to allow to pass between aggregation checks.
	
	
/****** Connect a particular site to be aggregated ******/
	public static function connectSite
	(
		string $siteHandle				// <str> The handle of the site to include in our aggregation feed.
	): bool							// RETURNS <bool> TRUE if the site was added, FALSE if not.
...
/****** Run an Aggregation check, and update if applicable ******/
	...
	): bool					// RETURNS <bool> TRUE if everything passed properly, FALSE if an error occurred.
...
/****** Pull the aggregate content and upload it to the current system ******/
	...
	(
		int $uniID			// <int> The UniID that authored this content.
	,	string $url			// <str> The URL where this content is being hosted.
	,	string $urlSlug		// <str> The URL slug where this content is being hosted.
	,	string $title			// <str> The title of this content.
	,	string $primaryHashtag	// <str> The primary hashtag assigned to this content.
	,	string $description	// <str> The description / description for this content.
	,	string $thumbnailURL	// <str> The URL for the image for this content.
	,	int $status			// <int> The status of the content.
	,	int $datePosted		// <int> The timestamp of when this content was posted.
	,	int $feedID			// <int> The ID of the feed submission.
	,	array <int, str> $hashtags		// <int:str> The list of hashtags associated with the content entry.
	): bool					// RETURNS <bool> TRUE if the entry was created, FALSE if not.
