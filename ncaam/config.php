...
define("SITE_SALT", "4Jj*OrDM!;jQwJLh_3*_EhPd2!-UnK3SlIm=JJhRjD.KaW_g=z7z#f8OlS7cJ5pE,n#");
...
define("SITE_HANDLE", "article_ncaam");
...
$config['site-name'] = "NCAA Men's Basketball";
$config['database']['name'] = "article_ncaam";
...
if(ENVIRONMENT == "production") {
	...
	// Set Important URLs
	define("SITE_URL", "http://ncaam.unifaction.com");
	define("CDN", "http://cdn.unifaction.com");
	
	// Important Configurations
	$config['site-domain'] = "ncaam.unifaction.com";		#production
...
************************************/
	...
	// Set Important URLs
	define("SITE_URL", "http://ncaam.phptesla.com");
	define("CDN", "http://cdn.phptesla.com");
	
	// Important Configurations
	$config['site-domain'] = "ncaam.phptesla.com";		#development
...
******************************/
	...
	// Set Important URLs
	define("SITE_URL", "http://ncaam.test");
	define("CDN", "http://cdn.test");
	
	// Important Configurations
	$config['site-domain'] = "ncaam.test";
