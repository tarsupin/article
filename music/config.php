...
define("SITE_SALT", "HqJW|!,cyTyFyNd6MF1wdccrNpIAH=lEwyll_67AC=~Ci!PUO37&_@u|B8r~LKsV4@q");
...
define("SITE_HANDLE", "article_music");
...
$config['site-name'] = "Music";
$config['database']['name'] = "article_music";
...
if(ENVIRONMENT == "production") {
	...
	// Set Important URLs
	define("SITE_URL", "http://music.unifaction.com");
	define("CDN", "http://cdn.unifaction.com");
	
	// Important Configurations
	$config['site-domain'] = "music.unifaction.com";		#production
...
************************************/
	...
	// Set Important URLs
	define("SITE_URL", "http://music.phptesla.com");
	define("CDN", "http://cdn.phptesla.com");
	
	// Important Configurations
	$config['site-domain'] = "music.phptesla.com";		#development
...
******************************/
	...
	// Set Important URLs
	define("SITE_URL", "http://music.test");
	define("CDN", "http://cdn.test");
	
	// Important Configurations
	$config['site-domain'] = "music.test";
