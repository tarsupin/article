...
define("SITE_SALT", "k.hvtZBjHvq6K6lD;uoP5P3=94xo*t30kRG,:j=lN6*TomNEIvloBs3ldk_5MrYfnR");
...
define("SITE_HANDLE", "article_fhl");
...
$config['site-name'] = "Federal Hockey League";
$config['database']['name'] = "article_fhl";
...
if(ENVIRONMENT == "production") {
	...
	// Set Important URLs
	define("SITE_URL", "http://fhl.unifaction.com");
	define("CDN", "http://cdn.unifaction.com");
	
	// Important Configurations
	$config['site-domain'] = "fhl.unifaction.com";		#production
...
************************************/
	...
	// Set Important URLs
	define("SITE_URL", "http://fhl.phptesla.com");
	define("CDN", "http://cdn.phptesla.com");
	
	// Important Configurations
	$config['site-domain'] = "fhl.phptesla.com";		#development
...
******************************/
	...
	// Set Important URLs
	define("SITE_URL", "http://fhl.test");
	define("CDN", "http://cdn.test");
	
	// Important Configurations
	$config['site-domain'] = "fhl.test";
