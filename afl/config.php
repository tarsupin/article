...
define("SITE_SALT", ";MTDDxVa5+R4!o4B~iV6!w,O~na=W+A2j_iSeasfh4swFy0fXxCMLDFJ.izjTBVCyM");
...
define("SITE_HANDLE", "article_afl");
...
$config['site-name'] = "Arena Football League";
$config['database']['name'] = "article_afl";
...
if(ENVIRONMENT == "production") {
	...
	// Set Important URLs
	define("SITE_URL", "http://afl.unifaction.com");
	define("CDN", "http://cdn.unifaction.com");
	
	// Important Configurations
	$config['site-domain'] = "afl.unifaction.com";		#production
...
************************************/
	...
	// Set Important URLs
	define("SITE_URL", "http://afl.phptesla.com");
	define("CDN", "http://cdn.phptesla.com");
	
	// Important Configurations
	$config['site-domain'] = "afl.phptesla.com";		#development
...
******************************/
	...
	// Set Important URLs
	define("SITE_URL", "http://afl.test");
	define("CDN", "http://cdn.test");
	
	// Important Configurations
	$config['site-domain'] = "afl.test";
