...
define("SITE_SALT", "5ZgX12TUZnTM@*xH5*KUNTgDu!5,rz~|QL;YeoM0u*W48i+wc3LHc!m9,I3V6Q,@7LR");
...
define("SITE_HANDLE", "article_aussiefootball");
...
$config['site-name'] = "Australian Football League";
$config['database']['name'] = "article_aussiefootball";
...
if(ENVIRONMENT == "production") {
	...
	// Set Important URLs
	define("SITE_URL", "http://aussiefootball.unifaction.com");
	define("CDN", "http://cdn.unifaction.com");
	
	// Important Configurations
	$config['site-domain'] = "aussiefootball.unifaction.com";		#production
...
************************************/
	...
	// Set Important URLs
	define("SITE_URL", "http://aussiefootball.phptesla.com");
	define("CDN", "http://cdn.phptesla.com");
	
	// Important Configurations
	$config['site-domain'] = "aussiefootball.phptesla.com";		#development
...
******************************/
	...
	// Set Important URLs
	define("SITE_URL", "http://aussiefootball.test");
	define("CDN", "http://cdn.test");
	
	// Important Configurations
	$config['site-domain'] = "aussiefootball.test";
