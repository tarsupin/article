...
define("SITE_SALT", "pIhs8m+84_BQ28CW1g=dk|AtCFDh95OkY3o.g8Afw+h_XUCHS8.5HN|TjVWNni|:ZA");
...
define("SITE_HANDLE", "article_actionsports");
...
$config['site-name'] = "Action Sports";
$config['database']['name'] = "article_actionsports";
...
if(ENVIRONMENT == "production") {
	...
	// Set Important URLs
	define("SITE_URL", "http://actionsports.unifaction.com");
	define("CDN", "http://cdn.unifaction.com");
	
	// Important Configurations
	$config['site-domain'] = "actionsports.unifaction.com";		#production
...
************************************/
	...
	// Set Important URLs
	define("SITE_URL", "http://actionsports.phptesla.com");
	define("CDN", "http://cdn.phptesla.com");
	
	// Important Configurations
	$config['site-domain'] = "actionsports.phptesla.com";		#development
...
******************************/
	...
	// Set Important URLs
	define("SITE_URL", "http://actionsports.test");
	define("CDN", "http://cdn.test");
	
	// Important Configurations
	$config['site-domain'] = "actionsports.test";
