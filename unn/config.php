...
define("SITE_SALT", "v1btZo70OV,YXyIZ9XJ6|@5@q.9~3EDqBf0cOu_BD:u5@VosCnriU9Wjf*LSbrCFJkk");
...
define("SITE_HANDLE", "article_unn");
...
$config['site-name'] = "UniFaction News Network";
$config['database']['name'] = "article_unn";
...
if(ENVIRONMENT == "production") {
	...
	// Set Important URLs
	define("SITE_URL", "http://unn.today");
	define("CDN", "http://cdn.unifaction.com");
	
	// Important Configurations
	$config['site-domain'] = "unn.today";		#production
...
************************************/
	...
	// Set Important URLs
	define("SITE_URL", "http://unn.today.phptesla.com");
	define("CDN", "http://cdn.phptesla.com");
	
	// Important Configurations
	$config['site-domain'] = "unn.today.phptesla.com";		#development
...
******************************/
	...
	// Set Important URLs
	define("SITE_URL", "http://unn.today.test");
	define("CDN", "http://cdn.test");
	
	// Important Configurations
	$config['site-domain'] = "unn.today.test";
