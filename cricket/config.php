...
define("SITE_SALT", "@ISQtszncDg!JrY4O+EZAvQ|wJHkr.glUa,3-_knpqNEF1Wx8tq56~P*^kW81ZR;Mxh");
...
define("SITE_HANDLE", "article_cricket");
...
$config['site-name'] = "Cricket";
$config['database']['name'] = "article_cricket";
...
if(ENVIRONMENT == "production") {
	...
	// Set Important URLs
	define("SITE_URL", "http://cricket.unifaction.com");
	define("CDN", "http://cdn.unifaction.com");
	
	// Important Configurations
	$config['site-domain'] = "cricket.unifaction.com";		#production
...
************************************/
	...
	// Set Important URLs
	define("SITE_URL", "http://cricket.phptesla.com");
	define("CDN", "http://cdn.phptesla.com");
	
	// Important Configurations
	$config['site-domain'] = "cricket.phptesla.com";		#development
...
******************************/
	...
	// Set Important URLs
	define("SITE_URL", "http://cricket.test");
	define("CDN", "http://cdn.test");
	
	// Important Configurations
	$config['site-domain'] = "cricket.test";
