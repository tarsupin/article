...
define("SITE_SALT", "4k_l|T=vCpmo7EwLbVKT8sYBSH6O-nZ.sqR._EF5lTeB~wfN!oLjO=:xh32Cd*~9hx");
...
define("SITE_HANDLE", "article_sphl");
...
$config['site-name'] = "Southern Professional Hockey League";
$config['database']['name'] = "article_sphl";
...
if(ENVIRONMENT == "production") {
	...
	// Set Important URLs
	define("SITE_URL", "http://sphl.unifaction.com");
	define("CDN", "http://cdn.unifaction.com");
	
	// Important Configurations
	$config['site-domain'] = "sphl.unifaction.com";		#production
...
************************************/
	...
	// Set Important URLs
	define("SITE_URL", "http://sphl.phptesla.com");
	define("CDN", "http://cdn.phptesla.com");
	
	// Important Configurations
	$config['site-domain'] = "sphl.phptesla.com";		#development
...
******************************/
	...
	// Set Important URLs
	define("SITE_URL", "http://sphl.test");
	define("CDN", "http://cdn.test");
	
	// Important Configurations
	$config['site-domain'] = "sphl.test";
