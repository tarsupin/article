...
define("SITE_SALT", "WRW!FofBzEiNqM-Jzaa:r8W7P=f5ugCe1C4a6BvAY9,Qk!fXSzmN=jnqlCN!Oof|q_");
...
define("SITE_HANDLE", "article_cfl");
...
$config['site-name'] = "Canadian Football League";
$config['database']['name'] = "article_cfl";
...
if(ENVIRONMENT == "production") {
	...
	// Set Important URLs
	define("SITE_URL", "http://cfl.unifaction.com");
	define("CDN", "http://cdn.unifaction.com");
	
	// Important Configurations
	$config['site-domain'] = "cfl.unifaction.com";		#production
...
************************************/
	...
	// Set Important URLs
	define("SITE_URL", "http://cfl.phptesla.com");
	define("CDN", "http://cdn.phptesla.com");
	
	// Important Configurations
	$config['site-domain'] = "cfl.phptesla.com";		#development
...
******************************/
	...
	// Set Important URLs
	define("SITE_URL", "http://cfl.test");
	define("CDN", "http://cdn.test");
	
	// Important Configurations
	$config['site-domain'] = "cfl.test";
