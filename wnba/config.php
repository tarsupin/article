...
define("SITE_SALT", "fMLcwYCegl+2:@qjc=qb-mE3~1=_DuD84,KGMu3dPuXvAf:bf:Tyyy*3~ZAbL:N.5XJ");
...
define("SITE_HANDLE", "article_wnba");
...
$config['site-name'] = "Women's National Basketball Association";
$config['database']['name'] = "article_wnba";
...
if(ENVIRONMENT == "production") {
	...
	// Set Important URLs
	define("SITE_URL", "http://wnba.unifaction.com");
	define("CDN", "http://cdn.unifaction.com");
	
	// Important Configurations
	$config['site-domain'] = "wnba.unifaction.com";		#production
...
************************************/
	...
	// Set Important URLs
	define("SITE_URL", "http://wnba.phptesla.com");
	define("CDN", "http://cdn.phptesla.com");
	
	// Important Configurations
	$config['site-domain'] = "wnba.phptesla.com";		#development
...
******************************/
	...
	// Set Important URLs
	define("SITE_URL", "http://wnba.test");
	define("CDN", "http://cdn.test");
	
	// Important Configurations
	$config['site-domain'] = "wnba.test";
