...
define("SITE_SALT", ".PMtQpstpH3yB_S7Nz!qKkApDEo5E8yXPo7=DFbV9_AbbZ_cpA7~SBGAQOb3eE7mxz");
...
define("SITE_HANDLE", "article_ncaah");
...
$config['site-name'] = "NCAA Hockey";
$config['database']['name'] = "article_ncaah";
...
if(ENVIRONMENT == "production") {
	...
	// Set Important URLs
	define("SITE_URL", "http://ncaah.unifaction.com");
	define("CDN", "http://cdn.unifaction.com");
	
	// Important Configurations
	$config['site-domain'] = "ncaah.unifaction.com";		#production
...
************************************/
	...
	// Set Important URLs
	define("SITE_URL", "http://ncaah.phptesla.com");
	define("CDN", "http://cdn.phptesla.com");
	
	// Important Configurations
	$config['site-domain'] = "ncaah.phptesla.com";		#development
...
******************************/
	...
	// Set Important URLs
	define("SITE_URL", "http://ncaah.test");
	define("CDN", "http://cdn.test");
	
	// Important Configurations
	$config['site-domain'] = "ncaah.test";
