...
$hashtagList = array("Biking", "Camping", "Caving", "Climbing", "Fishing", "Hiking", "Hunting", "Running", "TrailRunning", "Trapping");

// Prepare the Search Functionality
$searchArchetype = "outdoor";
...
ContentFeed::displayHeader("Outdoor Activities", $config['site-name'], "/");
