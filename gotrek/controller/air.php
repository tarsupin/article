...
$hashtagList = array("BASEJumping", "CaveDiving", "Freeflying", "HangGliding", "Paragliding", "Skydiving", "WingsuitFlying");

// Prepare the Search Functionality
$searchArchetype = "air-sports";
...
ContentFeed::displayHeader("Air Sports", $config['site-name'], "/");
