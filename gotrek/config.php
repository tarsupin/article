...
define("SITE_HANDLE", "article_gotrek");
...
$config['site-name'] = "GoTrek";
$config['database']['name'] = "article_gotrek";
...
if(ENVIRONMENT == "production") {
	...
	// Set Important URLs
	define("SITE_URL", "http://gotrek.today");
	define("CDN", "http://cdn.unifaction.com");
	
	// Important Configurations
	$config['site-domain'] = "gotrek.today";		#production
...
************************************/
	...
	// Set Important URLs
	define("SITE_URL", "http://gotrek.today.phptesla.com");
	define("CDN", "http://cdn.phptesla.com");
	
	// Important Configurations
	$config['site-domain'] = "gotrek.today.phptesla.com";		#development
...
******************************/
	...
	// Set Important URLs
	define("SITE_URL", "http://gotrek.today.test");
	define("CDN", "http://cdn.test");
	
	// Important Configurations
	$config['site-domain'] = "gotrek.today.test";
