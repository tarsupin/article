...
define("SITE_SALT", "~b;CS!AKaG*tmmqq2KEC|frBEW7Y*QE,p5sUl7km~l3W|OFe;p*zfLOVeTPNQwp9Mb4");
...
define("SITE_HANDLE", "article_tennis");
...
$config['site-name'] = "Tennis";
$config['database']['name'] = "article_tennis";
...
if(ENVIRONMENT == "production") {
	...
	// Set Important URLs
	define("SITE_URL", "http://tennis.unifaction.com");
	define("CDN", "http://cdn.unifaction.com");
	
	// Important Configurations
	$config['site-domain'] = "tennis.unifaction.com";		#production
...
************************************/
	...
	// Set Important URLs
	define("SITE_URL", "http://tennis.phptesla.com");
	define("CDN", "http://cdn.phptesla.com");
	
	// Important Configurations
	$config['site-domain'] = "tennis.phptesla.com";		#development
...
******************************/
	...
	// Set Important URLs
	define("SITE_URL", "http://tennis.test");
	define("CDN", "http://cdn.test");
	
	// Important Configurations
	$config['site-domain'] = "tennis.test";
