...
define("SITE_SALT", "yHZuTLbMN9n;HNMIbAmLH1tY,8detW8pcw8@3+bneAlnT-7dlLr8Y_F7naZH**=YG5");
...
define("SITE_HANDLE", "article_track");
...
$config['site-name'] = "Track and Field";
$config['database']['name'] = "article_track";
...
if(ENVIRONMENT == "production") {
	...
	// Set Important URLs
	define("SITE_URL", "http://track.unifaction.com");
	define("CDN", "http://cdn.unifaction.com");
	
	// Important Configurations
	$config['site-domain'] = "track.unifaction.com";		#production
...
************************************/
	...
	// Set Important URLs
	define("SITE_URL", "http://track.phptesla.com");
	define("CDN", "http://cdn.phptesla.com");
	
	// Important Configurations
	$config['site-domain'] = "track.phptesla.com";		#development
...
******************************/
	...
	// Set Important URLs
	define("SITE_URL", "http://track.test");
	define("CDN", "http://cdn.test");
	
	// Important Configurations
	$config['site-domain'] = "track.test";
