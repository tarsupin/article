...
define("SITE_SALT", "4pX|9JhB0kLWt@f7,bS|m:5*O+Fkf980rb,D+5AMNQoXx:7daYO0,Uow1tb.yBJXDr~*");
...
define("SITE_HANDLE", "article_fashion");
...
$config['site-name'] = "Fashion";
$config['database']['name'] = "article_fashion";
...
if(ENVIRONMENT == "production") {
	...
	// Set Important URLs
	define("SITE_URL", "http://fashion.unifaction.com");
	define("CDN", "http://cdn.unifaction.com");
	
	// Important Configurations
	$config['site-domain'] = "fashion.unifaction.com";		#production
...
************************************/
	...
	// Set Important URLs
	define("SITE_URL", "http://fashion.phptesla.com");
	define("CDN", "http://cdn.phptesla.com");
	
	// Important Configurations
	$config['site-domain'] = "fashion.phptesla.com";		#development
...
******************************/
	...
	// Set Important URLs
	define("SITE_URL", "http://fashion.test");
	define("CDN", "http://cdn.test");
	
	// Important Configurations
	$config['site-domain'] = "fashion.test";
