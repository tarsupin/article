...
define("SITE_SALT", "0Q+_x.,,r;L,!6uo4I@Got-uy,9z-Yz32bGw=PDfPfiXq08e;25HRq@I+M.xJ=3xY");
...
define("SITE_HANDLE", "article_roleplaying");

// Set the Application Path (in most cases, this is the same as CONF_PATH)
define("APP_PATH", dirname(CONF_PATH) . "/article");

// Site-Wide Configurations
$config['site-name'] = "Roleplaying Articles";
$config['database']['name'] = "article_roleplaying";
...
if(ENVIRONMENT == "production") {
	...
	// Set Important URLs
	define("SITE_URL", "http://roleplaying.unifaction.com");
	define("CDN", "http://cdn.unifaction.com");
	
	// Important Configurations
	$config['site-domain'] = "roleplaying.unifaction.com";		#production
...
************************************/
	...
	// Set Important URLs
	define("SITE_URL", "http://roleplaying.phptesla.com");
	define("CDN", "http://cdn.phptesla.com");
	
	// Important Configurations
	$config['site-domain'] = "roleplaying.phptesla.com";		#development
...
******************************/
	...
	// Set Important URLs
	define("SITE_URL", "http://roleplaying.test");
	define("CDN", "http://cdn.test");
	
	// Important Configurations
	$config['site-domain'] = "roleplaying.test";
